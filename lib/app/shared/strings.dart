class Strings {
  ...
  static const String subTitle = '''Every image is a story in frame. Discover my most
   popular images and uncover the stories behind them.''';

  static const String discoverButton = "Discover my work";
